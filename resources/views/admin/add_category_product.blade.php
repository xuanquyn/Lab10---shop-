...
control" name="category_product_desc" id="exampleInputPassword1" 
...
mục</label> 
                                    <textarea style="resize: none" rows="8" class="form
control" name="category_product_keywords" id="exampleInputPassword1" 
placeholder="Mô tả danh mục"></textarea> 
                                </div> 
                                <div class="form-group"> 
                                    <label for="exampleInputPassword1">Hiển thị</label> 
                                      <select name="category_product_status" class="form
control input-sm m-bot15"> 
